    ...
    return (
        ...
        >
          ...
          <defs>
            ...
            <div
                className='flex items-center justify-center w-full h-min'>
                <div className={`mx-auto w-full max-w-lg bg-white rounded-xl p-10 border border-black/10`}>
                    ...
                    <form onSubmit={handleSubmit(login)} className="mt-8">
                        ...
                        <div>
                            <Input className="text-violet-900 bg-violet-100 m-4 rounded-xl  px-2" type="password" label="Password: " placeholder="password" {...register("password", {
                                required: true
                            })} />
                        </div>
